...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-30 grid min-h-18 grid-cols-[auto_minmax(0,560px)_auto] items-center gap-3 border-b border-line bg-bg/90 px-[clamp(12px,4vw,64px)] py-3.5 backdrop-blur-xl">
